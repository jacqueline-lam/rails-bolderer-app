...
base_date = Date.today - 1.month - 15.days

problem_data = [
  # Sent by User 1
  [base_date, "Red V5", "Red", "V5", '<blockquote class="imgur-embed-pub" lang="en" data-id="f6jea5L"><a href="//imgur.com/f6jea5L">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>', ["compression", "slab"], "Pineapple"],
  [base_date, "Black V3", "Black", "V3", '<blockquote class="imgur-embed-pub" lang="en" data-id="yE9bcDH"><a href="//imgur.com/yE9bcDH">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>', ["crimps", "slab"], "Pineapple"],
  [base_date, "White V4", "White", "V4", '<blockquote class="imgur-embed-pub" lang="en" data-id="qhovyFu"><a href="//imgur.com/qhovyFu">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>', ["jugs", "powerful", "flexible"], "Pineapple"],
  [base_date, "Yellow V4", "Yellow", "V4", '<blockquote class="imgur-embed-pub" lang="en" data-id="whnG7Sd"><a href="//imgur.com/whnG7Sd">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>', ["crimps", "flexible", "balance", "slab"], "Logo"],
  [base_date, "Black V4", "Black", "V4", '<blockquote class="imgur-embed-pub" lang="en" data-id="WlIv118"><a href="//imgur.com/WlIv118">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>', ["body tension", "flexible", "mantle"], "Positivity"],
  [base_date + 1.month, "Sketchy White V4", "White", "V4", 'No original image available', ["slopers", "body tension", "compression", "overhang"], "Pineapple"],
  [base_date + 1.month, "Slopey Black V5", "Black", "V5", 'No original image available', ["slopers", "powerful", "slab", "flexible", "balance"], "Cave"],
  [base_date + 1.month, "Technical Green V5", "Green", "V5", "No original image available", ["pinches", "body tension", "overhang", "balance"], "Positivity"],
  [base_date + 1.month, "Purple V6", "Purple", "V6", "No original image available", ["pinches", "body tension", "compression", "powerful", "overhang", "balance"], "Positivity"],
  [base_date + 1.month, "White Deadpoint V5", "White", "V5", "No original image available", ["slopers", "pinches", "body tension", "flexible", "balance", "slab"], "Traverse"],

  # Sent by User 2
  [base_date, "Blue V6", "Blue", "V6", 'No original image available', ["crimps", "body tension", "flexible"], "Pineapple"],
  [base_date, "Black V6", "Black", "V6", 'No original image available', ["pinches", "body tension", "powerful", "overhang"], "Barrel"],
  [base_date, "Black V5", "Black", "V5", '<blockquote class="imgur-embed-pub" lang="en" data-id="jod5gFX"><a href="//imgur.com/jod5gFX">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>', ["body tension", "compression", "powerful"], "Pineapple"],
  [base_date, "Yellow V7", "Yellow", "V7", 'No original image available', ["crimps", "pinches", "powerful", "overhang"], "Pipe"],
  [base_date + 1.month, "Pink V7", "Pink", "V7", 'No original image available', ["crimps", "body tension", "powerful"], "Pineapple"],
  [base_date + 1.month, "Black V7", "Black", "V7", 'No original image available', ["slopers", "pinches", "compression", "powerful", "overhang"], "Positivity"],
  # Sent by User 3
  [base_date, "Blue V8", "Blue", "V8", '<blockquote class="imgur-embed-pub" lang="en" data-id="mbyzIOA"><a href="//imgur.com/mbyzIOA">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>', ["crimps", "body tension", "powerful"], "Pipe"],
  [base_date, "Pink V8", "Pink", "V8", '<blockquote class="imgur-embed-pub" lang="en" data-id="Rc01Obn"><a href="//imgur.com/Rc01Obn">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>', ["crimps", "slopers", "pinches", "body tension"], "Pipe"],
  [base_date + 1.month , "Blue V9", "Blue", "V9", '<blockquote class="imgur-embed-pub" lang="en" data-id="mBoDq6d"><a href="//imgur.com/mBoDq6d">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>', ["crimps", "body tension", "powerful"], "Positivity"]
]
...
problem_data.each do |data|
  ...
  # manually change and created_at date:
...
send_data = [
  ...
  [base_date + 1.month + 13.day, 23, '<blockquote class="imgur-embed-pub" lang="en" data-id="CzGchCO"><a href="https://imgur.com/CzGchCO">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>', true, user_1.id, "Purple V6"],
  ...
  [base_date + 1.day, 1, nil, false, user_2.id, "Black V5"],
  ...
  [base_date + 1.month + 1.day, 2, nil, false, user_3.id, "Black V7"],
